...
exports.HashtagPlugin = void 0;
var hashtag_1 = require('@lexical/hashtag');
...
function getHashtagRegexStringChars() {
  ...
  var otherChars = latinAccents + nonLatinChars + cjkChars;
  // equivalent of \p{L}
  var unicodeLetters =
    '\u0041-\u005A\u0061-\u007A\u00AA\u00B5\u00BA\u00C0-\u00D6\u00D8-\u00F6' +
    '\u00F8-\u0241\u0250-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EE\u037A\u0386' +
  ...
  var alpha = unicodeLetters + unicodeAccents + otherChars;
...
function getHashtagRegexString() {
  var _a = getHashtagRegexStringChars(),
    alpha = _a.alpha,
    alphanumeric = _a.alphanumeric,
    hashChars = _a.hashChars;
  var hashtagAlpha = '[' + alpha + ']';
  var hashtagAlphanumeric = '[' + alphanumeric + ']';
  var hashtagBoundary = '^|$|[^&/' + alphanumeric + ']';
  var hashCharList = '[' + hashChars + ']';
...
function HashtagPlugin() {
  ...
  var createHashtagNode = (0, react_1.useCallback)(function (textNode) {
    return (0, hashtag_1.$createHashtagNode)(textNode.getTextContent());
  }, []);
  var getHashtagMatch = (0, react_1.useCallback)(function (text) {
    var matchArr = REGEX.exec(text);
    if (matchArr === null) {
      return null;
    }
    var hashtagLength = matchArr[3].length + 1;
  ...
  (0, useLexicalTextEntity_1.useLexicalTextEntity)(
    getHashtagMatch,
